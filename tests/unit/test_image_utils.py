...
from document_ai_agents.image_utils import base64_to_pil_image, pil_image_to_base64_png
...
def test_pil_image_to_base64_png(test_image):
    """Test the `pil_image_to_base64_png` function."""
    # Convert the test image to base64
    base64_str = pil_image_to_base64_png(test_image)
    ...
    # Verify the binary data is a valid PNG image by loading it with PIL
